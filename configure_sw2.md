...
`switch2(config)# ip ftp username admin_FTP`   <br>
`switch2(config)# ip ftp password cisco`    <br>
`switch2(config)# ex`<br>
`switch2# copy running-config ftp:`    <br>
`Address or name of remote host []? 192.168.4.4`   <br>
`Destination filename []? Switch2_conf`    <br>
